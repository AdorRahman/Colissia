...
const CheckoutForm = ({ cb, loading = false }) => {
  const [errorMessage, setErrorMessage] = useState(null);
  const [isChecked, setIsChecked] = useState(false);
  const handelSubmit = (event) => {
    event.preventDefault();
    if (!isChecked) {
      return toast.error("You have to agree our terms and conditions!");
    }
    cb();
  };
  return (
    <form onSubmit={(event) => handelSubmit(event)}>
      <h2 className="hidden text-2xl text-white uppercase lg:block font-body">
        TERMS AND CONDITIONS
      </h2>
      <div className="hidden w-full h-40 p-2 my-2 overflow-auto border-2 lg:block">
        <h2 className="mt-2 text-3xl font-bold text-white uppercase lg:text-center">
          Colissia Terms of Use
        </h2>
        <div className="max-w-xl py-3 pl-6 pr-4 text-justify sm:mx-auto lg:max-w-3xl">
          <div className="mb-5">
            <p className="mb-2 text-body">
              These Terms and Conditions constitute a legally binding agreement
              made between you, whether personally or on behalf of an entity{" "}
              <em className="font-semibold">You</em>, and{" "}
              <em className="font-semibold">Colissia Global Ltd.</em>, located
              at{" "}
              <em className="font-semibold">
                {" "}
                House#27/4, Road#Beradanga-2, Rajbari, Dhaka, Bangladesh-7700
                (we, us),
              </em>
            ...
            <p className="mb-2 text-body">
              The Colissia website, accessible from https://colissia.com is a
              copyrighted work belonging to{" "}
              <em className="font-semibold">Colissia Global Ltd.</em> Certain
            ...
            <p className="text-body">
              <span className="uppercase">
                BY LOG INTO AND/OR USING THE SITE, YOU ARE BEING COMPLIANT TO
                THESE TERMS and you represent that you have the authority and
                capacity to enter into these Terms. YOU SHOULD BE AT LEAST 18
                YEARS OF AGE TO ACCESS THE SITE. IF YOU DISAGREE WITH ALL OF THE
                PROVISION OF THESE TERMS, YOU MUST DISCONTINUE IMMEDIATELY.
              </span>
            </p>
          </div>
            ...
            <ul className="py-3 sm:pl-5">
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                ...
                <p>
                  ...
                  website and saved by your browser. It is to identify your
                  browser, provide analytics, remember information about you
                  such as your product preferences or login information.
                </p>
              </li>
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                <i className="mr-3">
                ...
                <p>
                  ...
                  “Company”, “we”, “us” or “our”, it refers to Colissia Ltd.,
              ...
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                ...
                <p>
                  <strong>Country :</strong> where Colissia Global Ltd. or it’s
                  owners/founders are based, in this case Bangladesh.
                </p>
              </li>
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                <i className="mr-3">
                ...
                <p>
                  ...
                  organization or person that signs up to use Colissia’s
                  service.
                </p>
              </li>
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                ...
                <p>
                  ...
                  to visit the website and use the services.
                </p>
              </li>
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                <i className="mr-3">
                ...
                <p>
                  ...
                  Internet is assigned a number known as an protocol (IP)
              ...
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                ...
                <p>
                  ...
                  are employed by Colissia Global Ltd. or are under contract to
              ...
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                ...
                <p>
                  ...
                  Colissia Global Ltd. as described in the relative terms (if
              ...
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                ...
                <p>
                  ...
                  with Colissia to use the Services.
                </p>
              </li>
            </ul>
          </div>
          <div className="pt-24 mb-5" id="section-3" id="section-1">
            <h3 className="mb-3 text-2xl font-semibold text-white uppercase">
              1. Agreement to Terms
            </h3>
            <p className="mb-2 text-body">
              <strong className="text-white">1.1</strong> The Site provides the
              following services: Digital Gift Cards, Game Codes, Software Keys
              and so on (whatsoever available on the website, the “
              <strong>Services”</strong>). You agree that by accessing the Site
              and/or Services, you have read, understood, and agree to be bound
              by all of these Terms and Conditions. If you do not agree with all
              of these Terms and Conditions, then you are prohibited from using
              the Site and Services.
            </p>
            <p className="mb-2 text-body">
              <strong className="text-white">1.2</strong> The supplemental
              policies set out in Section 1.6 below, as well as any supplemental
              terms and condition or documents that may be posted on the Site
              from time to time, are expressly incorporated by reference.
            </p>
            <p className="mb-2 text-body">
              <strong className="text-white">1.3</strong> We may make changes to
              these Terms and Conditions at any time. The updated version of
              these Terms and Conditions will be indicated by an updated
              “Revised” date and the updated version will be effective as soon
              as it is accessible. You are responsible for reviewing these Terms
              and Conditions to stay informed of updates. Your continued use of
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">1.5</strong> The Site is intended
              for users who are at least 18 years old. If you are under the age
              of 18, you are not permitted to register for the Site or use the
              Services without parental permission.
            </p>
            <p className="mb-2 text-body">
              <strong className="text-white">1.6</strong> Additional policies
            ...
            <ul className="py-3 sm:pl-5">
              ...
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                ...
                <p>
                  ...
                  , which will apply if you purchase from the Site and want any
                  Return/Refund.
                </p>
              </li>
            </ul>
          </div>
          <div className="pt-24 mb-5" id="section-3" id="section-2">
            <h3 className="mb-3 text-2xl font-semibold text-white uppercase">
              2. Acceptable Use
            </h3>
            <p className="mb-2 text-body">
              <strong className="text-white">2.1</strong> The following terms
              ...
              Content <em>(i)</em> that violates any third-party right or any
              intellectual property or proprietary right;<em>(ii)</em> that is
              ...
              harm of any kind against any group or individual; <em>(iii)</em>{" "}
              that is harmful to minors in any way; or <em>(iv)</em> that is in
              violation of any law, regulation, or obligations or restrictions
              imposed by any third party.
            </p>
            <p className="mb-2 text-body">
              In addition, you agree not to: <em>(i)</em> upload, transmit, or
              distribute to or through the Site any software intended to damage
              or alter a computer system or data; <em>(ii)</em> send through the
              Site unsolicited or unauthorized advertising, promotional
              materials, junk mail, spam, chain letters, pyramid schemes, or any
              other form of duplicative or unsolicited messages; <em>(iii)</em>{" "}
              use the Site to harvest, collect, gather or assemble information
              or data regarding other users without their consent; <em>(iv)</em>{" "}
              interfere with, disrupt, or create an undue burden on servers or
              networks connected to the Site, or violate the regulations,
              policies or procedures of such networks; <em>(v)</em> attempt to
              gain unauthorized access to the Site, whether through password
              mining or any other means; <em>(vi)</em> harass or interfere with
              any other user’s use and enjoyment of the Site; or <em>(vii)</em>{" "}
            ...
            <p className="mb-2 text-body">
              ...
              arising out of <em>(a)</em> your use of the Site, <em>(b)</em>{" "}
              your violation of these Terms, <em>(c)</em> your violation of
              applicable laws or regulations or <em>(d)</em> your User Content.
              ...
              of Company. Company will use reasonable efforts to notify you of
              any such claim, action or proceeding upon becoming aware of it.
            </p>
            <p className="mb-2 text-body">
              <strong className="text-white">2.2</strong> The rights approved to
              you in these Terms are subject to the following restrictions:{" "}
              <em>(a)</em> you shall not sell, rent, lease, transfer, assign,
              distribute, host, or otherwise commercially exploit the Site;{" "}
              <em>(b)</em> you shall not change, make derivative works of,
              disassemble, reverse compile or reverse engineer any part of the
              Site; <em>(c)</em> you shall not access the Site in order to build
              a similar or competitive website; and <em>(d)</em> except as
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">2.3 </strong>Company grants you a
              non-transferable, non-exclusive, revocable, limited license to
              access the Site solely for your own personal use.
            </p>
            <p className="mb-2 text-body">
              <strong className="text-white">2.4 </strong>You may not access or
              use the Site for any purpose other than that for which we make the
              site and our services available. The Site may not be used in
          ...
          <div className="pt-24 mb-5" id="section-3">
            ...
            <p className="mb-2 text-body">
              ...
              complete and relate to you and not a third party; <em>(b)</em> you
              will maintain the accuracy of such information and promptly update
              such information as necessary; <em>(c)</em> you will keep your
              password confidential and will be responsible for all use of your
              password and account; <em>(d)</em> you have the legal capacity and
              you agree to comply with these Terms and Conditions; and{" "}
              <em>(e)</em> you are not a minor in the jurisdiction in which you
            ...
            <p className="mb-2 text-body">
              In case you know or suspect that anyone other than you knows your
          ...
          <div className="pt-24 mb-5" id="section-4">
            ...
            <p className="mb-2 text-body">
              ...
              content that a user submits or posts to the Site or send feedback
              to us. You understand and agree that your User Content may be
              viewed by other users on the Site, and that they may be able to
              see who has posted that User Content. You are exclusively
              responsible for your User Content.
            </p>
            <p className="mb-2 text-body">
              <strong>4.2</strong> You further agree that we can use your User
              Content for any other purposes whatsoever in perpetuity without
              payment to you, and combine your User Content with other content
              for use within the Site and otherwise. We do not have to attribute
              your User Content to you. When you upload or post content to our
              site, you grant us the following rights to use that content:
            </p>
            <p className="mb-2 text-body">
              <em>(a)</em> In posting User Content, including reviews or making
              contact with other users of the Site you shall comply with our
              Acceptable Use Policy.
            </p>
            <p className="mb-2 text-body">
              <em>(b)</em> You warrant that any User Content does comply with
              our Acceptable Use Policy, and you will be liable to us and
              indemnify us for any breach of that warranty. This means you will
              be responsible solely for your content and any loss or damage we
              suffer as a result of your breach of this warranty.
            </p>
            <p className="mb-2 text-body">
              <em>(c)</em> We have the right to remove any User Content you put
              on the Site if, in our opinion, such User Content does not comply
              with the Acceptable Use Policy.
            </p>
            <p className="mb-2 text-body">
              <em>(d)</em> We are not responsible and accept no liability for
              any User Content including any such content that contains
              incorrect information or is defamatory or loss of User Content. We
              accept no obligation to screen, edit or monitor any User Content
              but we reserve the right to remove, screen and/or edit any User
              Content without notice and at any time. User Content has not been
              verified or approved by us and the views expressed by other users
              on the Site do not represent our views or values.
            </p>
            <p className="mb-2 text-body">
              <em>(e)</em> Each Site user is solely responsible for any and all
          ...
          <div className="pt-24 mb-5" id="section-5">
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">5.2</strong> Except as expressly
              provided in these Terms and Conditions, no part of the Site,
              Services or Our Content may be copied, reproduced, aggregated,
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">5.3</strong> Provided that you are
              eligible to use the Site, you are granted a limited license to
              access and use the Site and Our Content and to download or print a
            ...
            <p className="mb-2 text-body">
              ...
              <em>(a)</em> try to gain unauthorized access to the Site or any
              networks, servers or computer systems connected to the Site;
              and/or <em>(b)</em> make for any purpose including error
            ...
            <p className="mb-2 text-body">
              ...
              reasonable efforts to update the information on our site, we make
              no representations, warranties or guarantees, whether express or
              implied, that Our Content on the Site is accurate, complete or up
              to date.
            </p>
          </div>
          <div className="pt-24 mb-5" id="section-6">
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">6.1</strong> The Site may contain
              links to websites or applications operated by third parties. We do
              not have any influence or control over any such third party
              websites or applications or the third party operator. We are not
              responsible for and do not review, approve, monitor, endorse,
              warrant, or make any representations to any third party websites
              or applications or their availability or content.
            </p>
            <p className="mb-2 text-body">
              <strong className="text-white">6.2</strong> We accept no
              responsibility for adverts contained within the Site. If you agree
              to purchase goods and/or services from any third party who
              advertises in the Site, you do so at your own risk. The
              advertiser, and not us, is responsible for such goods and/or
              services and if you have any questions or complaints in relation
          ...
          <div className="pt-24 mb-5" id="section-7">
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">7.1</strong> We reserve the right
              at our sole discretion, to <em>(a)</em> monitor the Site for
              breaches of these Terms and Conditions; <em>(b)</em> take
              appropriate legal action against anyone in breach of applicable
              laws or these Terms and Conditions; <em>(c)</em> refuse, restrict
              access to or availability of, or disable (to the extent
              technologically feasible) any of your Contributions; <em>(d)</em>{" "}
              ...
              systems; and <em>(e)</em> otherwise manage the Site in a manner
              designed to protect our rights and property and to facilitate the
              proper functioning of the Site and Services.
            </p>
            <p className="mb-2 text-body">
              <strong className="text-white">7.2</strong> We do not guarantee
              that the Site will be secure or free from bugs or viruses.
            </p>
            <p className="text-body">
              <strong className="text-white">7.3</strong> You are responsible
              for configuring your information technology, computer programs and
              platform to access the Site and you should use your own virus
              protection software.
            </p>
          </div>
          <div className="pt-24 mb-5" id="section-8">
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">8.1</strong> We reserve the right
              to change, modify, or remove the contents of the Site at any time
              or for any reason at our sole discretion without notice. We also
              reserve the right to modify or discontinue all or part of the
              Services without notice at any time.
            </p>
            <p className="mb-2 text-body">
              <strong className="text-white">8.2</strong> We cannot guarantee
              the Site and Services will be available at all times. We may
          ...
          <div className="pt-24 mb-5" id="section-9">
            ...
            <p className="mb-2 text-body">
              ...
              server; <em>(c)</em> any interruption or cessation of transmission
              to or from the site or services; and/or <em>(d)</em> any bugs,
              viruses, trojan horses, or the like which may be transmitted to or
              through the site by any third party. We will not be responsible
              for any delay or failure to comply with our obligations under
              these Terms and Conditions if such delay or failure is caused by
          ...
          <div className="pt-24 mb-5" id="section-10">
            ...
            <p className="mb-2 text-body">
              ...
              Site or Services or are otherwise a user of the Site, as
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">10.2</strong> Without limiting any
              ...
              deny access to and use of the Site and the Services (including
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">10.3</strong> If we terminate or
              suspend your account for any reason set out in{" "}
          ...
          <div className="pt-24 mb-5" id="section-11">
            ...
            <p className="mb-2 text-body">
              ...
              access&nbsp;the Services via a mobile application, then we grant
            ...
            <p className="mb-2 text-body">
              <strong>11.2</strong>&nbsp;The following terms apply&nbsp;when you
            ...
            <p className="mb-2 text-body">
              <em>(a)</em> The license granted to you for our mobile application
              is limited to a non-transferable license to use the application on
              a device that utilizes the Apple iOS or Android operating system,
              as applicable, and in accordance with the usage rules set forth in
              the applicable App Distributor terms of service;
            </p>
            <p className="mb-2 text-body">
              <em>(b)</em> We are responsible&nbsp;for providing any maintenance
              and support services with respect to the mobile application as
              specified in these Terms and Conditions or as otherwise required
              under applicable law. You acknowledge that each App Distributor
              has no obligation whatsoever to furnish any maintenance and
              support services with respect to the mobile application;
            </p>
            <p className="mb-2 text-body">
              <em>(c)</em> In the event of any failure of the mobile application
            ...
            <p className="mb-2 text-body">
              ...
              located in a country that is subject to a Bangladesh government
              embargo, or that has been designated by the Bangladesh government
              as a “terrorist supporting” country; and (ii) you are not listed
              on any Bangladesh government list of prohibited or restricted
              parties;
            </p>
            <p className="mb-2 text-body">
              <em>(e)</em> You must comply with applicable third party terms of
              agreement when using the mobile application; and
            </p>
            <p className="mb-2 text-body">
              <em>(f)</em> You acknowledge and agree that the App Distributors
              are third party beneficiaries of these Terms and Conditions, and
              that each App Distributor will have the right (and will be deemed
              to have accepted the right) to enforce these Terms and Conditions
          ...
          <div className="pt-24 mb-5" id="section-12">
            ...
            <p className="mb-2 text-body">
              All rights reserved by Colissia Global Ltd. All trademarks, logos
            ...
            <p className="mb-2 text-body">
              ...
              U.S.C. § 512(c)) must be provided to our designated office:
            </p>
            <ul className="py-3 sm:pl-5">
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                <i className="mr-3">
              ...
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                ...
                <p>
                  ...
                  owner, its agent, or under the law.
                </p>
              </li>
              <li className="relative flex items-baseline justify-start mb-2 text-body">
                <i className="mr-3">
          ...
          <div className="pt-24 mb-5" id="section-13">
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">13.1</strong> Visiting the Site,
            ...
            <p className="mb-2 text-body">
              ...
              Site or in respect to the Services constitute the entire agreement
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">13.4</strong> We may assign any or
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">13.6</strong> If any provision or
              part of a provision of these Terms and Conditions is unlawful,
            ...
            <p className="mb-2 text-body">
              <strong className="text-white">13.8</strong> A person who is not a
              party to these Terms and Conditions shall have no right under the
              Contracts (Rights of Third Parties) Act 1999 to enforce any term
              of these Terms and Conditions.
            </p>
            <p className="mb-2 text-body">
              <strong className="text-white">13.9</strong> In order to resolve a
              complaint regarding the Services or to receive further information
              regarding use of the Services, please contact us by email at{" "}
              <a href="mailto:contact@colissia.com">contact@colissia.com</a> or
              by post to:
            </p>
            <p className="mb-2 text-body">
      ...
      <div className="inline-flex items-center">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            className="text-green-500 duration-300 hover:text-green-300"
          >
            Terms and Conditions
          </a>
        </span>
      ...
      <div className="block text-center">
        <button
          type="submit"
          disabled={loading}
          className="inline px-16 py-2 mt-5 font-medium text-center uppercase transition-colors bg-white rounded-full outline-none whitespace-nowrap text-dark focus:outline-none hover:bg-primary hover:text-white"
        >
          {loading ? (
