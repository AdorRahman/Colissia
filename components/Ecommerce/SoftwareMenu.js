...
import { FaItunes, FaGooglePlay, FaGamepad, FaSteam } from "react-icons/fa";
...
const SoftwareMenu = () => {
  ...
  return (
    ...
    >
      <a className="cursor-pointer">Software</a>
      <Transition
        show={showMenu}
        as={Fragment}
