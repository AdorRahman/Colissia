...
import { adminSidebarTabs } from "@components/AdminLayout";
    ...
    <Transition.Root as={Fragment} show={isOpen}>
      ...
      >
        ...
        <Transition.Child
          ...
          as={Fragment}
        >
          <div className="left-0 shadow-xl absolute top-0 h-full w-72 bg-white">
            <div className="w-full h-full flex flex-col justify-between py-6">
              <div className="w-full flex flex-col space-y-2 px-6">
                <div className="w-full flex justify-end">
                  <a className="text-primary-500" onClick={() => closeModal()}>
                ...
                {adminSidebarTabs.map((item) => (
                  <span onClick={() => closeModal()} key={item.title}>
                    <ActiveLink
                      ...
                      href={item.href}
                    >
                      <a className="focus:outline-none hover:text-blue text-primary-900 flex items-center py-2 hover:bg-primary-50 rounded-full px-4 mr-auto">
